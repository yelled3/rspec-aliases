...
module RSpec
  ...
  module Matchers
    ...
    def self.alias_method(new_name, old_name, &description_override)
      alias_matcher(new_name, old_name, &description_override)
    end
...
puts RSpec::Matchers.all_res.to_json
